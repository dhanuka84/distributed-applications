...
def kafkaLogDir = System.getenv('APPLICATION_LOG');
def kafkaConfigDir = System.getenv('APPLICATION_CONFIG');
def kafkaDefaultLogDir = "/application_log";
def kafkaConfFileName = "/application.properties";
...
if(kafkaConfigDir == null){
    ...
    kafkaConfigDir = USER_HOME + "/application_config"
}
...
logger("org.reactor.monitoring", DEBUG,["FILE"],false)
